...
function Set-LoftLights {
    ...
    .PARAMETER HomeAssistantUrl
        Home Assistant URL (default: https://ha.err.services)
    ...
    try {
        switch ($PSCmdlet.ParameterSetName) {
            { $_ -ne "TurnOff" } {
                ...
                $Result = Invoke-HomeAssistantService -Service "turn_on" -ServiceData $ServiceData -HomeAssistantUrl $HomeAssistantUrl -TimeoutSeconds $TimeoutSeconds
            }
            
            "TurnOff" {
                Write-Verbose "Turning off loft lights"
                $Result = Invoke-HomeAssistantService -Service "turn_off" -HomeAssistantUrl $HomeAssistantUrl -TimeoutSeconds $TimeoutSeconds
            }
        }
...
Export-ModuleMember -Function Set-LoftLights